...
**Milestone 5 — Generation and interface:** I will use Claude to write the generation step and a simple interface. As input, I will give it my Evaluation Plan and my retrieval function. I will ask it to send the user's question plus the top 5 retrieved reviews to the Claude API and return an answer that cites which reviews it used. I expect a small command-line (or simple web) interface where I type a question and get a cited answer. I will verify it by asking my 5 evaluation questions and comparing the answers to my expected answers.
